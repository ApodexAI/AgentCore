# pyright: reportDeprecated=false, reportMissingTypeArgument=false, reportUnknownParameterType=false, reportUnknownVariableType=false
...
class SpawnGuard:
    ...
    # :class:`~agent_core.components.observers.wall_clock_guard.\
