...
# via LLM_STREAM_STALL_S under any supported prefix; <= 0 disables.
_STREAM_STALL_DEFAULT_S = 180.0
_STREAM_STALL_ENV = "LLM_STREAM_STALL_S"
...
# set ~45.
_FIRST_CHUNK_ENV = "LLM_FIRST_CHUNK_S"
...
# via LLM_STREAM_STALL_MAX under any supported prefix; default 2 (one retry, then
# advance). <= 0 disables the escape (retry to the budget as before).
_STREAM_STALL_MAX_ENV = "LLM_STREAM_STALL_MAX"
