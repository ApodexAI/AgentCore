...
from agent_core.runtime.resources.permissions import get_effective_tools_for_role
...
class ResourceManager:
    ...
    def __init__(
        ...
        *,
        ...
        self._role_llm_factory = role_llm_factory
    ...
    def _resolve_base_llm(self, role_id: str | None) -> LLMClient:
        ...
        return resolve_base_llm_for_role(
            ...
            role_llm_factory=self._role_llm_factory,
        )
